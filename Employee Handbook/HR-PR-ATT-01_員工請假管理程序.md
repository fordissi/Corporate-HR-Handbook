...
| --- | --- | --- | --- | --- | --- |
| v0.1 |  | 初版草案建立 | 蔡家瑋 |  |  |
| v0.2 | 2026-07-07 | 補充提前請假原則、臨時請假補辦、考勤影響說明及可預見請假申請時限 | 蔡家瑋 |  |  |
| v0.3 | 2026-07-14 | 補充現行請假、銷假及留職停薪以公司指定系統或行動 App 申請為原則 | 蔡家瑋 |  |  |
...
### 1. 系統申請
- 本公司請假、銷假及留職停薪申請，原則上應於公司指定系統或行動 App 內提出（現行為 104 App）。
- 員工應事先於系統或行動 App 填寫請假單，敘明理由與時間，經核定後方可離開崗位。
- 留職停薪申請應依適用假別、事由及證明文件規定，於系統或行動 App 填寫留職停薪申請單；如系統無法完整附載說明或附件，應另依人事課要求補充文件。
...
## 七、 銷假與變更
- 假期屆滿應準時銷假上班；如需提前返工、取消或縮短已核准假期，應於公司指定系統或行動 App 填寫銷假單或依人事課指定方式辦理。
- 如需續假，應依上述程序重新辦理請假申請。
