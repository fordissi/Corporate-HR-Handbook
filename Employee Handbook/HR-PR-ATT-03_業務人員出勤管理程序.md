...
為規範在外執行公務之業務人員出勤管理，確保打卡紀錄之真實性與公平性，特訂定本辦法。所有業務人員之每日出勤起訖、客戶拜訪、任務型行程與里程紀錄，均依本規範辦理。
...
- **任務型行程定義**：除一般客戶拜訪、醫療院所拜訪、會議、展會等行程外，凡因執行公司業務而前往非醫療院所地點處理特定任務者，均屬「任務型行程」。例如載送客戶、協助客戶處理文件或行政事項、配送或領取與業務相關物品、前往政府機關或合作單位辦理事項等。
- **任務型行程打卡原則**：任務型行程如有移動至非固定客戶地點，且該行程將產生工時或里程者，員工仍應依規定進行 GPS 打卡，不得因地點非醫療院所或非客戶正式營業地址而免除打卡義務。打卡時應於系統備註任務性質、對象、事由及地點。
- **定位防弊與稽核機制**：公司將透過輔助系統自動結合 GPS 紀錄與客戶拜訪紀錄進行交叉比對。若發生以下情形，系統將主動標示異常並提示主管，員工須負舉證與說明之責：
  1. 打卡地點周遭無對應之客戶紀錄。
  2. 實際打卡時間與預定拜訪的客戶時間落差過大。
  3. 系統里程預估與實際申報里程差距過大。
  4. 屬任務型行程，但未於備註欄明確說明任務內容、往返地點或對應對象。
...
- 任務型行程之處理地點如為非醫療院所、非客戶正式登記地址或其他臨時指定場所，仍應於**任務開始地點**完成 GPS 打卡；如任務結束後即前往下一行程，則應於**抵達下一站時再次打卡**。
- 任務型行程若屬單獨往返之工作，例如載送客戶、代辦事項、取送文件或物品、陪同客戶前往特定場所等，應至少記錄以下資訊：任務名稱、服務對象、起點、迄點、事由、打卡時間及實際行駛里程；必要時主管得要求補充通訊紀錄、照片、單據或其他可資佐證資料。
...
- _里程申報原則_：凡任務型行程有申報交通補助、油資或其他與里程相關之費用者，其申報內容應與 GPS 打卡紀錄、任務備註及實際往返路線相互一致；如未依規定完成打卡或備註不清，主管得退回申報、要求補件或不予認列。
